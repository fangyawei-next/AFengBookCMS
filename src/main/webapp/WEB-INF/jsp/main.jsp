...
<link href="${pageContext.request.contextPath}/green/css/base.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/green/css/platform.css" rel="stylesheet">
<link rel="stylesheet" href="${pageContext.request.contextPath}/custom/green/uimaker/easyui.css">
</head> 
<body>
    <div class="container">
        <div id="pf-hd">
            <div class="pf-logo">
                <img src="${pageContext.request.contextPath}/green/images/main/main_logo.png" alt="logo">
            </div>
            ...
            <div class="pf-user">
                ...
                <div class="pf-user-photo">
                    <img src="${pageContext.request.contextPath}/green/images/main/user.png" alt="">                   
                </div>
                <h4 class="pf-user-name ellipsis">${sessionScope.sysUser.userName}</h4>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/custom/green/jquery.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/custom/green/jquery.easyui.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/green/js/menu.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/green/js/main.js"></script>
    <!--[if IE 7]>
